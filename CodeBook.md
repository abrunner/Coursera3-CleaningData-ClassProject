...
####Codebook for "tidy\_data_smartphone_measurements_by_subject_by_activity.txt"
...
3 header columns (subject, activity, group) and 66 numeric columns of the mean data for each patient for each activity for each of the 66 mean and std features.  Features are normalized and bounded within [-1,1].
